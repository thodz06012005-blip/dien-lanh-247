...
export default function ConnectivityBanner() {
  ...
  return (
    <div
      className={`fixed inset-x-0 top-0 z-[2000] border-b px-4 py-3 shadow-lg backdrop-blur motion-safe:animate-[connectivity-slide_.2s_ease-out] ${
        offline
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-center gap-3 text-sm font-semibold">
        ...
        <span>
          {offline
            ? 'Mất kết nối tới hệ thống. Không tiếp tục thao tác điều phối cho đến khi kết nối được khôi phục.'
            : 'Kết nối đã được khôi phục. Dữ liệu đang được đồng bộ lại.'}
        </span>
