...
const staticEntries = [
  ...
  { path: '/policy/booking', changefreq: 'yearly', priority: '0.4' },
  { path: '/policy/cancellation', changefreq: 'yearly', priority: '0.4' },
  { path: '/policy/pricing', changefreq: 'yearly', priority: '0.4' },
  { path: '/policy/complaints', changefreq: 'yearly', priority: '0.3' },
  { path: '/policy/cookies', changefreq: 'yearly', priority: '0.3' },
